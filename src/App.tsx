...
const logos = ["ANURAG", "T S", "SOFTWARE", "DEVELOPER"];
        ...
        <div className="min-h-screen bg-black text-white overflow-x-hidden">
          ...
          <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-12 py-5 backdrop-blur-xl bg-black/20 border-b border-white/10">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 flex items-center justify-center rounded-lg bg-gradient-to-br from-white/20 to-white/5 border border-white/10 shadow-[0_0_15px_rgba(255,255,255,0.1)]">
                <span className="text-white text-lg tracking-tighter" style={{ fontFamily: 'Anton, sans-serif' }}>A</span>
              </div>
...
animate-[shine_4s_linear_infinite]">
    ...
    from-white via-white/60 to-white
    animate-[shine_4s_linear_infinite]">
                  Turning complex problems into secure, scalable, and{" "} <br />
                ...
                <a
                  href="https://github.com/Anurag3215"
                  target="_blank"
