...
const projects = [
  {
    title: "Palette Space",
    desc: "A beautiful web application to explore and create stunning color palettes and modern typography for design.",
    tech: "React + Node.js",
    thumbnail: "/assets/website.png",
    github: "https://github.com/Anurag3215/Palette-Space",
    live: "https://palettespace-ants.vercel.app/",
  }
];
...
function ProjectCard({ item }: { item: typeof projects[0] }) {
  return (
    ...
    >
      <a href={item.live} target="_blank" rel="noopener noreferrer" className="block relative h-48 overflow-hidden bg-white/5">
        <img
          src={item.thumbnail}
          alt={item.tech}
      ...
      <div className="p-5 flex items-center justify-between">
        <div className="flex flex-col gap-1.5">
          ...
          {item.desc && (
            <p className="text-xs text-white/60 mt-1 max-w-[200px] leading-relaxed line-clamp-2">
              {item.desc}
            </p>
          )}
        </div>
...
export default function ShowcaseSection() {
  ...
  return (
    <section className="relative w-full min-h-[85vh] md:min-h-screen bg-black/70 overflow-hidden text-white px-4 sm:px-8 md:px-16 lg:px-24 py-0 md:py-12 -mt-16 sm:mt-0 md:mt-12">
