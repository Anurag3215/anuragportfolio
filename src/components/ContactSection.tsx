...
export default function ContactSection() {
    ...
    const handleSend = () => {
        ...
        const email = "anuragaacc@gmail.com";
    ...
    animate-[shine_4s_linear_infinite]"
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-5 mt-2">
                            ...
                            {/* gmail */}
                            <a
                                href="mailto:anuragaacc@gmail.com"
  ...
  animate-[headingReveal_1s_cubic-bezier(0.22,1,0.36,1)_0.15s_forwards]"
    ...
    bg-clip-text text-transparent"
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-5">
                        {/* LinkedIn */}
                        <a
                            href="https://www.linkedin.com/in/anurag-t-s/"
                            target="_blank"
    ...
    hover:-translate-y-1.5 hover:scale-105 hover:border-white/30"
                        >
                            {/* YOUR LINKEDIN GRADIENT */}
                            <div
                                className="absolute inset-0 opacity-0 transition-opacity duration-500 group-hover:opacity-100"
                                style={{
                                    background:
                                        "linear-gradient(45deg, #0077b5, #0077b5, #0077b5)",
                                }}
                            />
