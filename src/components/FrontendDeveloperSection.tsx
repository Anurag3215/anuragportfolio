...
export default function FrontendDeveloperSection() {
  ...
  return (
    ...
    <motion.section
      ...
      className="relative w-full min-h-screen bg-black/70 text-white overflow-hidden flex items-start px-6 md:px-20 pt-16 md:pt-28 select-none"
    >
      {/* TEXT */}
    ...
    animate-[shine_4s_linear_infinite]"
        >
          Building robust MERN stack applications and focusing on cybersecurity.
          Exploring AI technologies to solve real-world problems.
        </motion.p>
        ...
        >
          {["MongoDB", "Express.js", "React.js", "Node.js", "Python", "SQL"].map((tech) => (
            <div
              key={tech}
              className="
