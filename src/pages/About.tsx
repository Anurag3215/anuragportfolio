...
<body>
    <div class="container">
        <div class="resume-wrapper">
            <!-- Header -->
            <div class="header">
                <img src="/assets/anurag.png" alt="Anurag T S" class="profile-photo">
                <div class="header-content">
                    <h1>Anurag T S</h1>
                    <p class="title">Software Developer | Cybersecurity & AI Enthusiast</p>
                    <div class="contact-info">
                        ...
                        <div class="contact-item">
                            <span class="contact-icon">✉︎</span>
                            <a href="mailto:anuragaacc@gmail.com">anuragaacc@gmail.com</a>
                        </div>
                        <div class="contact-item">
                            <span class="contact-icon">🔗</span>
                            <a href="https://www.linkedin.com/in/anurag-t-s/" target="_blank">LinkedIn</a>
                        </div>
                        <div class="contact-item">
                            <span class="contact-icon">⛆</span>
                            <a href="https://github.com/Anurag3215" target="_blank">Anurag3215</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        a.href = url;
        a.download = "Anurag_T_S_Resume.html";
      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-screen gap-8">
        ...
        >
          ...
          >
            ...
            >
              <p>
                Technology has become more than just an area of study for me—it's the career I genuinely want to build.
              </p>

              <p>
                Although I explored different subjects during my academic journey, I eventually discovered that my real passion lies in programming, cybersecurity, and artificial intelligence. As I spent more time learning about software development and modern technologies, my interest in coding grew stronger.
              </p>

              <p>
                Currently, I am pursuing my Master of Computer Applications (MCA), where I continue to strengthen my technical knowledge while working on real-world projects. I have completed a MERN Stack Development Bootcamp and enjoy building full-stack web applications using MongoDB, Express.js, React.js, and Node.js. I also have experience with Git, GitHub, JavaScript, Python, Java, C, and SQL.
              </p>

              <p>
                Among all areas of technology, ethical hacking and cybersecurity fascinate me the most. I enjoy learning how systems work, identifying security vulnerabilities, understanding the mindset of attackers, and exploring ways to protect digital infrastructure. My long-term goal is to build a successful career as a cybersecurity professional while continuously expanding my knowledge in ethical hacking and digital security.
              </p>

              <p>
                I am also passionate about artificial intelligence and enjoy exploring how AI can automate tasks, improve decision-making, and solve real-world problems. Learning about emerging AI technologies motivates me to keep improving my technical skills and stay updated with the latest innovations.
              </p>

              <p>
                I believe that continuous learning is the key to success in the technology industry. Every project I build, every challenge I solve, and every new concept I learn brings me one step closer to achieving my career goals.
              </p>

              <p>
                For me, technology is not just a profession—it's a passion, a mindset, and the field where I see myself making a meaningful impact in the future.
              </p>
            </div>
          </div>
        </motion.div>
